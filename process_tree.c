...
/*
 * FIXIT:
 * Я не разбирался, как именно работает ваша программа, но мне кажется, 
 * что без обхода дерева, например, в глубину, задачу не решить.
 * 
 * Давайте вы сделаете работающий вариант с цепочкой, а если будет желание, то уже с деревом.
 */
